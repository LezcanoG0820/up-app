...
INSERT INTO "new_User" ("apellido", "cedula", "departamentoId", "email", "id", "nombre", "passwordHash", "rol") SELECT "apellido", "cedula", "departamentoId", "email", "id", "nombre", "passwordHash", "rol" FROM "User";
DROP TABLE "User";
