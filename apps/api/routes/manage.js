...
const CRUS = [
  ...
  // === CAMPUS (FACULTADES) ===
  { slug: 'campus-medicina', nombre: 'Fac. MEDICINA' },
  { slug: 'campus-admon-empresas', nombre: 'Fac. ADMON. DE EMPRESAS Y CONTABILIDAD' },
  { slug: 'campus-derecho', nombre: 'Fac. DERECHO Y CIENCIAS POLÍTICAS' },
  { slug: 'campus-admon-publica', nombre: 'Fac. ADMINISTRACIÓN PÚBLICA' },
  { slug: 'campus-odontologia', nombre: 'Fac. ODONTOLOGÍA' },
  { slug: 'campus-ciencias-educacion', nombre: 'Fac. CIENCIAS DE LA EDUCACIÓN' },
  { slug: 'campus-humanidades', nombre: 'Fac. HUMANIDADES' },
  { slug: 'campus-ciencias-agropecuarias', nombre: 'Fac. CIENCIAS AGROPECUARIAS' },
  { slug: 'campus-psicologia', nombre: 'Fac. PSICOLOGÍA' },
  { slug: 'campus-enfermeria', nombre: 'Fac. ENFERMERÍA' },
  { slug: 'campus-medicina-veterinaria', nombre: 'Fac. MEDICINA VETERINARIA' },
  { slug: 'campus-informatica', nombre: 'Fac. INFORMÁTICA ELECTRÓNICA Y COMUNIC.' },
  { slug: 'campus-arquitectura', nombre: 'Fac. ARQUITECTURA Y DISEÑO' },
  { slug: 'campus-ciencias-naturales', nombre: 'Fac. CIENCIAS NATURALES, EXACTAS Y TEC.' },
  { slug: 'campus-bellas-artes', nombre: 'Fac. BELLAS ARTES' },
  { slug: 'campus-farmacia', nombre: 'Fac. FARMACIA' },
  { slug: 'campus-comunicacion-social', nombre: 'Fac. COMUNICACIÓN SOCIAL' },
  { slug: 'campus-ingenieria', nombre: 'Fac. INGENIERÍA' },
];
